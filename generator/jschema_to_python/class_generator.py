...
class DataclassesImportGenerator:
    ...
    def _dependent_modules_import(self) -> Sequence[str]:
        ...
        if self._dependent_modules:
            import_str += f"\n\nfrom . import {', '.join(self._dependent_modules)}"
        return import_str
...
class DataclassesPropertyGenerator:
    ...
    def __repr__(self) -> str:
        ...
        return (
            ...
            f'\n    """{self.property_schema.get("description")}"""'
        )
...
class DataclassesClassGenerator(ClassGenerator):
    ...
    def _write_class_declaration(self):
        ...
        print("")
        print("")
        print("@dataclasses_json.dataclass_json(letter_case=dataclasses_json.LetterCase.CAMEL, undefined=dataclasses_json.Undefined.EXCLUDE)")
